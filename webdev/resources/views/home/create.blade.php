...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    ...
    <hr> {!! Form::open(array('route' => 'match.store', 'data-parsley-validate' => '','method' => 'Post','id'=>'myForm')) !!} {{ Form::label('start_at', 'start_at:') }} {{ Form::date('start_at', null, array('class' => 'form-control', 'required' => '', 'maxlength'
